...
const FloatingSupport = () => {
    ...
    const [whatsappNumber, setWhatsappNumber] = useState('+8801234567890');
    const [telegramUsername, setTelegramUsername] = useState('your_telegram');
    ...
    const fetchSupportLinks = async () => {
        try {
            ...
            if (telegramData?.value) setTelegramUsername(telegramData.value);
        } catch (error) {
        ...
        <div className="floating-support">
            ...
            {isOpen && (
                <div className="support-menu">
                    ...
                    <button 
                        className="support-option telegram"
